...
export default function ControlPanel({ 
  ...
  const [roomStatus, setRoomStatus] = useState("🌐 Status room: Not connected");
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-xl w-[380px] p-6 flex flex-col gap-6 overflow-y-auto">
      <h2 className="text-base font-semibold tracking-tight">🎙️ Voice Verification</h2>
      ...
      {isAgentSpeaking && (
        <div className="text-center mb-4">
          ...
          <small className="text-gray-500 text-xs">Agent sedang berbicara...</small>
        </div>
      )}
