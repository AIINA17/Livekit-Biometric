...
export default function VoiceEnrollment({ token, setVerifyStatus }: VoiceEnrollmentProps) {
  const handleEnroll = async () => {
    ...
    try {
      ...
      recorder.onstop = async () => {
        ...
        try {
          const res = await fetch(`${process.env.NEXT_PUBLIC_SERVER_URL}/enroll-voice`, {
            method: 'POST',
            headers: {
